...
contract YoUsdUsdcOracleTest is Test {
    ...
    function setUp() public {
        // Fork Base mainnet to read live convertToAssets from yoUSD
        vm.createSelectFork(vm.envString("BASE_RPC_URL"));
        require(block.chainid == 8453, "chain isn't Base");
    }
    ...
    function testYoUsdUsdc_OracleMatchesVaultExchangeRate() public {
        ...
        console2.log("yoUSD.convertToAssets(sample):", YO_USD_VAULT.convertToAssets(baseSample));
        console2.log("baseSample:", baseSample);
